...
def sketch(abundance_table, OUT_DIR):
    os.mkdir('Figure_tmp')
    dict_table = {}
    ...
    shutil.move('Figure_tmp/nitrogen_cycle.png', os.path.join(OUT_DIR, 'nitrogen_cycle_sketch.png'))
    ...
    shutil.move('Figure_tmp/sulfur_cycle.png', os.path.join(OUT_DIR, 'sulfur_cycle_sketch.png'))
    ...
    shutil.move('Figure_tmp/DMSP_cycle.png', os.path.join(OUT_DIR, 'DMSP_cycle_sketch.png'))
    ...
    shutil.move('Figure_tmp/carbon_cycle.png', os.path.join(OUT_DIR, 'carbon_cycle_sketch.png'))
    
    # 删除临时文件夹
    shutil.rmtree('Figure_tmp')
